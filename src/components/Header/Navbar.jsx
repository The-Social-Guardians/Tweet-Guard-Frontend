...
function Navbar({ showMenu }) {
  ...
  return (
    <article
      ...
      } absolute left-0 top-0 h-screen w-2/3 bg-gradient-to-r from-neutral-200 to-sky-200 backdrop-blur-xl transition-transform duration-300 ease-in-out lg:static lg:mr-10 lg:h-auto lg:grow lg:translate-x-0 lg:bg-gradient-to-r lg:from-transparent`}
    >
